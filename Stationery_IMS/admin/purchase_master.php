...
{
    mysqli_query($link,"insert into purchase_master values(NULL,'$_POST[companyname]','$_POST[productname]','$_POST[unit]','$_POST[packingsize]',$_POST[qty],$_POST[price],'$_POST[supplier]','$_POST[payment_method]','$_POST[date_of_purchase]')")or die(mysqli_error($link));

    ...
    <div id="content">
      <form name="form1" action="" method="post" class="form-horizontal nopadding">
        ...
        <div id="content-header">
            <div id="breadcrumb"><a href="#" class="tip-bottom"><i class="fas fa-cash-register"></i>Sales Master</a></div>
        </div>
        ...
        <div class="container-fluid">
                ...
                <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;">
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"><span class="icon"> <i class="fas fa-coins"></i> </span>
                            ...
                            <div class="widget-content nopadding">
                                ...
                                <div class=" span4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="span12" name="phno" id="phno" required>
                                ...
                                <div class="span3">
                                    ...
                                    <div>
                                        ...
                                        <select class="span12" name="paytypeheader">
                                            <option>Cash</option>
                                            <option>Debit</option>
                                            <option>UPI</option>
                                ...
                                <div class="span2">
                                    ...
                                    <div>
                                        <label>Date</label>
                                        <input type="text" class="span12" name="billdate" value="<?php echo date("Y-m-d") ?>" readonly>
                                    </div>
                                </div>
            ...
            <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;">
                <div class="span12">
                    ...
                    <h4>
                        <div style="float: right"><span style="float:left;">Total:&#8377;</span><span style="float: left id=" id="totalbill">0</span></div>
                    </h4>
                    ...
                    <center>
                        <input type="submit" name ="generateBill" value="generate bill" class="btn btn-success">
                    </center>
...
function load_price(packingsize)
{
  ...
  xmlhttp.open("GET","forajax/load_price.php?productname="+productname+"&companyname="+companyname+"&unit="+unit+"&packingsize="+packingsize,true);
  xmlhttp.send();
}
...
function add_session()
{
  ...
  xmlhttp.open("GET","forajax/save_in_session.php?productname="+productname+"&companyname="+companyname+"&unit="+unit+"&packingsize="+packingsize+"&price="+price+"&qty="+qty+"&total="+total,true);
  xmlhttp.send();
}
...
function load_billing_products()
{
  ...
  xmlhttp.onreadystatechange=function()
  {
    if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
    {
      document.getElementById("billproducts").innerHTML=xmlhttp.responseText;
      load_total_bill()
    }
  };
...
function edit_qty(qty1,compname,prodname,unit1,packsize,price1)
{

  //alert(qty1+"=="+compname+"=="+prodname+"=="+unit1+"=="+packsize+"=="+price1);

  var companyname = compname;
  var productname = prodname;
  var unit = unit1;
  var packingsize = packsize;
  var price = price1;
  var qty = qty1;
  ...
  xmlhttp.open("GET","forajax/update_in_session.php?productname="+productname+"&companyname="+companyname+"&unit="+unit+"&packingsize="+packingsize+"&price="+price+"&qty="+qty+"&total="+total,true);
  xmlhttp.send();
...
function delete_qty(sessionid)
{
  ...
  xmlhttp.onreadystatechange=function()
  {
    if(xmlhttp.readyState == 4 && xmlhttp.status == 200)
    {
      ...
      {
          load_billing_products();
          //alert("Product quantity deleted");
      }
      else {
        load_billing_products();
          alert(xmlhttp.responseText);
...
function generate_bill_no($id)
{
  ...
  switch($len)
  {
    case "1" : $id1 = '0000'.$id1;break;
    case "2" : $id1 = '000'.$id1;break;
    case "3" : $id1 = '00'.$id1;break;
    case "4" : $id1 = '0'.$id1;break;
    case "5" : $id1 = $id1;break;
  }
  return $id1;
}
...
//check if phno is in customertable if not then add
  $res = mysqli_query($link,"select * from customers");
  $count = 0;
  while($row=mysqli_fetch_array($res))
  {
    if($row["phno"]==$_POST["phno"])
    {
      $count++;
    }
  }
  ...
  if($count==0)
  {
   mysqli_query($link,"insert into customers values('$_POST[phno]','$_POST[fullname]')");
  }

  $lastbillno=0;

  mysqli_query($link,"insert into billing_header values(NULL,'$_POST[phno]','$_POST[paytypeheader]','$_POST[billdate]','$_POST[billno]',NULL)")or die(mysqli_error($link));
  ...
  for($i=0;$i<$max;$i++)
  {
    ...
    if(isset($_SESSION['cart'][$i]))
    {
      ...
      {
      mysqli_query($link,"insert into billing_details values(NULL,'$lastbillno','$companyname_session','$productname_session','$unit_session','$packsize_session','$price_session','$qty_session')")or die(mysqli_error($link));
      mysqli_query($link,"update stock_master set prod_qty = prod_qty-$qty_session where company_name='$companyname_session' && product_name='$productname_session' && product_unit ='$unit_session' && prod_pack_size = '$packsize_session'");
      }
    }
  }
  unset($_SESSION["cart"]);

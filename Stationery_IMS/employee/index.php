...
<div id="loginbox">
    <form name="loginform" class="form-vertical" action="" method = "post">
        ...
        <div class="form-actions">
          ...
          <button type="button" name="adminLogin" class="btn btn-warning" onclick="window.location.href=' ../admin/homepage.php'">Admin Login</button>
          </center>
        </div>
    </form>
    ...
    if(isset($_POST["LOGIN"]))
    {
      ...
      $count = 0;
      $res = mysqli_query($link,"select * from user_registration where username = '$username' && password = '$password' && role = 'employee' && status = 'active'");
